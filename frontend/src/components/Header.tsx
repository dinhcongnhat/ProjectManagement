...
const Header = ({ onMenuClick }: HeaderProps) => {
    ...
    return (
        <header
            className="h-16 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex items-center px-4 lg:px-6 sticky top-0 z-50 shadow-sm"
        >
            {/* Mobile Menu Button */}
            <motion.button
                onClick={onMenuClick}
                className="lg:hidden p-2.5 -ml-2 mr-2 rounded-xl bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 active:bg-gray-300 dark:active:bg-gray-500 transition-colors"
                    ...
                    <AnimatePresence>
                        {showNotifications && (
                            <>
                                ...
                                >
                                    <div className="md:hidden w-full h-full bg-white dark:bg-gray-800 relative shadow-inner flex flex-col pt-safe">
